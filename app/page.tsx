...
export default function Home() {
  ...
  return (
    <>
      {/* Scroll anchor - invisible div for navbar navigation */}
      <Box
        id='home'
        sx={{
          position: 'relative',
      ...
      <Box component='main'>
        ...
        <Box
          component='section'
          sx={{
            minHeight: 'calc(100vh - 64px)', // 100vh - navbar height (64px for desktop, 56px for mobile)
            '@media (max-width: 900px)': {
              minHeight: 'calc(100vh - 56px)', // Mobile navbar height
            },
            ...
            position: 'relative',
            overflow: 'hidden',
            // No padding-top needed since navbar is fixed and doesn't push content
          }}
        >
          {/* Background Pattern */}
          <Box
              ...
              <Grid size={{ xs: 12, md: 6 }}>
                <Stack spacing={4}>
                  <Box>
                    ...
                    >
                      Kickstart your next web project with Next.js 15, React 19,
                      TypeScript 5, and Material-UI 7. Production-ready,
                      developer-friendly, and beautifully designed.
                    </Typography>
                  </Box>
            ...
            <Grid container spacing={6} alignItems='center'>
              <Grid size={{ xs: 12, md: 6 }}>
                <Box>
                  ...
                  >
                    This boilerplate is designed to get you up and running
                    quickly with a modern, scalable web application foundation
        ...
        >
          <Container maxWidth='lg'>
            <Box sx={{ textAlign: 'center', mb: 8 }}>
              ...
              >
                Clone this boilerplate and start building your next amazing web
                application
              </Typography>
            </Box>
